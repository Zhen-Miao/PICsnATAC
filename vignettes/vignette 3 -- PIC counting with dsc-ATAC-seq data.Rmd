---
title: "Vignette 2 -- PIC counting with dsc-ATAC-seq data"
...
```{r eval=FALSE}
cm = read.table('GSE123576_mousebrain_cellData_revision.tsv', sep = '\t', header= T)
...
```{r eval=FALSE}
feature_df = read.csv('GSE123576_mousebrain_peaks_revision.bed', sep = '\t', header = F)
