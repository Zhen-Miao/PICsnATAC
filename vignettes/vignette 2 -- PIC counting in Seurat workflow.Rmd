...
```{r eval=FALSE}
metadata <- read.csv('atac_pbmc_5k_nextgem_singlecell.csv', header = T )
# -- in your own Cell Ranger output, the file name will be 'singlecell.csv'
cells <- setdiff(metadata$barcode, 'NO_BARCODE')
# -- usually, 10X Cell Ranger first line is 'NO_BARCODE'
```
