...
#' Internal function -- get the region by cell type matrix and capturing rate
#'
#'
...
#'   \item itermat_p_by_type recorded region by cell type matrix in each iteration
#'   \item itermat_q_by_type recorded capturing rates in each iteration
#' }
#'  and
#' @export
#'
